...
public class StatsListenerMBean implements DynamicMBean {

    private StatsListener _listener;
    
    public StatsListenerMBean( StatsListener listener ){
    	_listener = listener;
    }

    @Override
    public Object getAttribute(String attribute) throws AttributeNotFoundException, MBeanException, ReflectionException {
     StatsSummary stats = _listener.getFilteredSummary();
    ...
    public AttributeList getAttributes(String[] attributes) {
    	StatsSummary stats = _listener.getSummary();
    ...
    public MBeanInfo getMBeanInfo() {
        ...
        return new MBeanInfo(_listener.getClass().getCanonicalName(),
